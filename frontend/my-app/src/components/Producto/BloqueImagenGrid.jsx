...
/* <div className="grid___container">
            <div className="img__container--img--grande"><img  className="img__grid" src={props.imagen[0].url} alt="" /></div>
            <div className="img__container--chica1"><img  className="img__grid" src={props.imagen[1].url} alt="" /></div>
            <div className="img__container--chica2"><img  className="img__grid" src={props.imagen[2].url} alt="" /></div>
