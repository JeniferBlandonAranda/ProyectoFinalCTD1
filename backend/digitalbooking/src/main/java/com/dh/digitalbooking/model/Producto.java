...
public class Producto {
    ...
    public Producto (String nombre, String tituloDescripcion, String descripcion, Categoria categoria, Ciudad ciudad, List <Imagen> imagen, List <Caracteristica> caracteristica, String normas, String seguridad,String cancelacion){
        this.nombre=nombre;
