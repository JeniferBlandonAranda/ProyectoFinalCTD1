...
import com.dh.digitalbooking.repository.IProductoRepository;
...
public class ProductoService{
    ...
    public Producto modificarProducto(Producto producto){
        ...
        List <Caracteristica> caracteristicas = producto.getCaracteristica();
        Long id=producto.getIdProducto();

        if(iProducto.findById(id).get()==null)
            return null;

        iProducto.updateById(Nombre,tituloDesc,Descripcion,categoria,ciudad,caracteristicas,id);
